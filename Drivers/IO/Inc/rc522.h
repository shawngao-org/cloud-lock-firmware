...
#ifndef CLOUD_LOCK_RC522_H
#define CLOUD_LOCK_RC522_H
...
void IC_RW(u8 *UID, u8 key_type, u8 *KEY, u8 RW, u8 data_addr,
           u8 *data); // UID为你要修改的卡的UID key_type：0为KEYA，非0为KEYB KEY为密钥 RW:1是读，0是写 data_addr为修改的地址 data为数据内容
